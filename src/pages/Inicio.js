...
const Inicio = ({ setTema }) => {
  ...
  //         "https://api.jsonbin.io/b/62504f5b7b69e806cf4ac257/1"
  //       );
  ...
  return (
    <>
      ...
      <h2 className="fs-3 text-center">TOP 10 PERÚ</h2>
      <section className="py-1 px-2 mx-auto" style={{ maxWidth: "1600px" }}>
        <Top10Cards></Top10Cards>
      </section>

      <h2 className="fs-3 text-center">SUGERENCIAS</h2>
      <section className="py-1 px-2 mx-auto" style={{ maxWidth: "1600px" }}>
        <Sugerencias></Sugerencias>
      </section>

      <h2 className="fs-3 text-center">LO MÁS VISTO</h2>
      <section className="py-1 px-2 mx-auto" style={{ maxWidth: "1600px" }}>
