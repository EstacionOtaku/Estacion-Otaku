...
import "../../styles/scss/ModalAvatar.scss";

const ModalAvatar = ({ setImageHeader }) => {
  return (
    <>
      <section className="portada">
        <figure className="portada__image-contaiener">
          <img src={Portada} className="portada__image" alt="portada"></img>
        </figure>
      </section>
      <div className="modal-avatar">
        <section className="title ">
          <figure className="title__image-container">
            <img src={logo} className="title__image" alt="logo"></img>
          </figure>
